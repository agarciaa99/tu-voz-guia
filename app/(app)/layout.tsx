...
import { FloatingAssistant } from "@/features/app/components/floating-assistant";
import { WebViewerProvider } from "@/features/app/components/web-viewer";
      ...
      <ScreenReaderProvider>
        <WebViewerProvider>
          <div className="min-h-screen bg-background relative">
            ...
            {/* Floating AI Assistant - always available on top of everything */}
            <FloatingAssistant />
          </div>
        </WebViewerProvider>
      </ScreenReaderProvider>
