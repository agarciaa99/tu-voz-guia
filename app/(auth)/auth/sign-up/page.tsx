    ...
    <div className="animate-fade-up">
      <div className="glass rounded-3xl p-8 glow-border">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start your voice-first journey</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-12 pl-11 rounded-xl bg-secondary/50 border-border/50 focus:border-accent/50 transition-colors"
              />
            </div>
          </div>
